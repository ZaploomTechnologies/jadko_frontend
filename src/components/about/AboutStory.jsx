        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              Backed by <strong className="text-gray-900">29+ years of diagnostic expertise</strong>, JADKO combines deep clinical knowledge with modern technology to build a scalable and trusted diagnostic network.
            </p>
