    ...
    <section className="py-20 bg-gray-50/50 relative overflow-hidden">
      ...
      <div className="container max-w-6xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 auto-rows-auto md:auto-rows-[160px]">
          ...
          <div className="md:col-span-1 md:row-span-1 group relative bg-white rounded-3xl p-5 border border-amber-300 border-b-4 border-b-amber-400 shadow-sm hover:shadow-xl transition-all duration-500 flex items-center space-x-4 overflow-hidden">
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl bg-gradient-to-br from-amber-500/15 to-yellow-500/15 -z-10 pointer-events-none"></div>
            <div className="shrink-0 w-10 h-10 rounded-xl bg-amber-50 text-amber-600 flex items-center justify-center group-hover:animate-wiggle">
          ...
          <div className="md:col-span-1 md:row-span-1 group relative bg-white rounded-3xl p-5 border border-emerald-300 border-b-4 border-b-emerald-400 shadow-sm hover:shadow-xl transition-all duration-500 flex items-center space-x-4 overflow-hidden">
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl bg-gradient-to-br from-emerald-500/15 to-teal-500/15 -z-10 pointer-events-none"></div>
            <div className="shrink-0 w-10 h-10 rounded-xl bg-emerald-50 text-emerald-600 flex items-center justify-center group-hover:animate-wiggle">
          ...
          <div className="md:col-span-2 md:row-span-1 group relative bg-white rounded-3xl p-6 border border-purple-300 border-b-4 border-b-purple-400 shadow-sm hover:shadow-xl transition-all duration-500 flex items-center justify-between overflow-hidden">
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl bg-gradient-to-br from-purple-500/15 to-pink-500/15 -z-10 pointer-events-none"></div>
            <div className="flex items-center space-x-5">
              <div className="w-10 h-10 rounded-xl bg-purple-50 text-purple-600 flex items-center justify-center group-hover:animate-wiggle">
