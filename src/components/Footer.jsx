    ...
    <footer className="relative bg-white pt-16">
      ...
      <div className="container pb-12">
          ...
          <div>
            ...
            <ul className="space-y-6">
              <li className="flex gap-4 items-start group">
                ...
                <span className="text-gray-600">Level 8, Tower B, Business Park, Tech Center, India</span>
              </li>
              <li className="flex gap-4 items-start group">
              ...
              <li className="flex gap-4 items-start group">
                ...
                <span className="text-gray-600">support@jadko.com</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-gray-500 text-sm">
          <p>© 2025 JADKO Healthcare Solutions Pvt Ltd. All rights reserved.</p>
