        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="lg:w-1/2">
            ...
            <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
              <p>
                Backed by over 29+ years of industry experience and expertise, JADKO is committed to transforming healthcare across India. We leverage technology, clinical expertise, and an asset-light franchise model to deliver high-quality testing far from metro centers.
              </p>
              <p>
