...
const QuickLinkCard = ({ icon: Icon, label, colorClass, onClick, useWhatsApp }) => (
  <button onClick={onClick} className="flex items-center gap-3 bg-white/10 backdrop-blur-sm border border-white/20 p-4 rounded-xl hover:bg-white/20 transition-all hover:-translate-y-1 w-full md:w-auto">
    <div className={`w-10 h-10 rounded-lg ${colorClass} flex items-center justify-center`}>
      {useWhatsApp ? <WhatsAppIcon /> : <Icon className="w-5 h-5 text-white" />}
    </div>
      ...
      <section className="relative pt-12 pb-24 md:pt-20 md:pb-32 overflow-hidden">
        ...
        <div className="jadko-container relative z-10 text-center text-white">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <QuickLinkCard icon={MessageCircle} label="WhatsApp Us" colorClass="bg-green-500" onClick={() => window.open('https://wa.me/919033608708', '_blank')} useWhatsApp />
